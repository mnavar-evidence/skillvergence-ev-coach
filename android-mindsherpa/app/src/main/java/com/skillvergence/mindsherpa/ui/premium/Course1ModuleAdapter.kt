...
/**
 * RecyclerView Adapter for Course 1.0 Modules
 * Displays the 7 individual modules with play buttons
 */
class Course1ModuleAdapter(
    private val modules: List<Course1Module>,
    private val onModuleClick: (Course1Module) -> Unit
) : RecyclerView.Adapter<Course1ModuleAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // Extract module number from ID (e.g., "1-1" -> "1.1")
